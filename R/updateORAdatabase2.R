...
# NOTE: Make sure you have permission to write to specified directory, e.g. execute R with admin rights!
        ...
        # Changing logical structure of workflow:
        # First: download current Evidence Codes, so that no local files are required (outdated files!)
...
# QS    : Outcommented following part of code
# Reason: Get and save EvidenceCodes.names prior to update in order to use the
#         most recent EvidenceCodes and not outdated ones from previous versions
##########################################################################################
## EvidenceCodes.names #########################################################
##########################################################################################
# Erstelle Datei mit allen Evidence Codes mit denen NCBIs zu GO-Termen annotiert sein koennen.
